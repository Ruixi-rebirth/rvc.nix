...
final: prev: {
  nvidia-cusolver-cu11 = prev.nvidia-cusolver-cu11.overrideAttrs (old: {
    buildInputs = (old.buildInputs or [ ]) ++ [ final.nvidia-cublas-cu11 ];
    preFixup = (old.preFixup or "") + ''
      addAutoPatchelfSearchPath ${final.nvidia-cublas-cu11}/${python.sitePackages}/nvidia/cublas/lib
    '';
  });
  ...
  torch = prev.torch.overrideAttrs (
    old:
    pkgs.lib.optionalAttrs (builtins.hasAttr "nvidia-cublas-cu11" final) {
      ...
      preFixup = (old.preFixup or "") + ''
        addAutoPatchelfSearchPath ${final.nvidia-cublas-cu11}/${python.sitePackages}/nvidia/cublas/lib
        addAutoPatchelfSearchPath ${final.nvidia-cuda-cupti-cu11}/${python.sitePackages}/nvidia/cuda_cupti/lib
        addAutoPatchelfSearchPath ${final.nvidia-cuda-nvrtc-cu11}/${python.sitePackages}/nvidia/cuda_nvrtc/lib
        addAutoPatchelfSearchPath ${final.nvidia-cuda-runtime-cu11}/${python.sitePackages}/nvidia/cuda_runtime/lib
        addAutoPatchelfSearchPath ${final.nvidia-cudnn-cu11}/${python.sitePackages}/nvidia/cudnn/lib
        addAutoPatchelfSearchPath ${final.nvidia-cufft-cu11}/${python.sitePackages}/nvidia/cufft/lib
        addAutoPatchelfSearchPath ${final.nvidia-curand-cu11}/${python.sitePackages}/nvidia/curand/lib
        addAutoPatchelfSearchPath ${final.nvidia-cusolver-cu11}/${python.sitePackages}/nvidia/cusolver/lib
        addAutoPatchelfSearchPath ${final.nvidia-cusparse-cu11}/${python.sitePackages}/nvidia/cusparse/lib
        addAutoPatchelfSearchPath ${final.nvidia-nccl-cu11}/${python.sitePackages}/nvidia/nccl/lib
      '';
      ...
      addNvrtcRpathPhase = ''
        ...
        for library in "$out/${python.sitePackages}/torch/lib/"*.so*; do
          ...
          found_nvrtc=1
          patchelf --add-rpath \
            '${final.nvidia-cuda-nvrtc-cu11}/${python.sitePackages}/nvidia/cuda_nvrtc/lib' \
            "$library"
        done
